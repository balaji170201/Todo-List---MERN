...
function Register() {
  ...
  return (
    ...
    <div class="w-full max-w-xs mx-auto mt-6">
        ...
        <p className='text-xs mt-4 text-center'>Already have an account? <a href='/login'><span class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800">Login</span></a> </p>
        </form>
